...
urlpatterns = [
    ...
    path('material/buscar/', views.buscar_material, name='buscar_material'),
    ...
    path('ventas/buscar/', views.buscar_tratamiento, name='buscar_tratamiento'),
    path('citas/buscar/', views.buscar_cita, name='buscar_cita'),
    path('historial_medico/buscar/', views.buscar_historial_medico, name='buscar_historial_medico'),
