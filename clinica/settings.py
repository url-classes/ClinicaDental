...
DATABASES = {
    'default': {
        ...
        'PASSWORD': 'josuebarr10sJS',  # Contraseña del usuario de la base de datos
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'especialidadeslapaz1@gmail.com'
EMAIL_HOST_PASSWORD = 'ipbe rrrd zrnx plhr'
